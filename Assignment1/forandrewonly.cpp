...
{ // Part 1 cached:
    ...
    */
    ...
    std::string hi = R"((?:std::hex)(?:w?)?(p_a:e+t/r){4}[^[:lower:]]{3}!?&+[[:punct:]^]+\1{2}x£[^erd].{4}&%!(?:¢:65?43`{7}){4}\1-)" + ss.str();
    //std::regex xeger{R"((?:std::hex)(?:w?)?(\t_a:e+t/r){4}[^[:lower:]]{3}!?&+[[:punct:]^]+\1{2}x[^erd].{4}&%!(?:¢:65?43[[:s:]]{7}){4}-)"};
    //std::string word = "std::hexp_a:et/rp_a:et/rp_a:et/rp_a:et/rAAC!&&^;.p_a:et/rp_a:et/rx£afedr&%!¢:643```````¢:643```````¢:643```````¢:643```````p_a:et/r-_-_-_-__-_-:453643636#€@_-_-_-__-_-:453643636#€@_-_-_-__-_-:453643636#€@_-_-_-__-_-:453643636#€@_-_-_-__-_-:453643636#€@a";
